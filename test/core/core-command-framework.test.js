...
test("the declarative catalog exposes exactly the lean public command surface", () => {
  ...
  assert.deepEqual(listPublicCommandPaths(), [
    ...
    "config review set",
    "config review clear",
    "config leader-next-action",
    "config leader-next-action show",
    "config leader-next-action set",
    ...
    "task review retry",
    "task review finding",
    "task review finding list",
    "task review finding dispose",
    "task review finding repair-wave",
    "task review finding extract",
    "task integration",
