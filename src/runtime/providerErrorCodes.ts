 ...
 * Claude surfaces HTTP/2 stream errors, API errors, and policy denials as
 * free text; this function is the single place that understands Claude's
 * error format.
 */
...
/**
 * Parses a Codex CLI failure into a structured code. Codex currently has no
 * StopFailure hook; failures surface through transcript exit messages. This
 * parser is ready for when that path is wired up.
 */
